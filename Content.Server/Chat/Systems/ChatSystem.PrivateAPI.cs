...
public sealed partial class ChatSystem
{
        ...
        )
    {
        ...
        if (HasComp<CanFormatMessagesComponent>(source))
            isFormatted = true; // Sunrise-Edit
        ...
        )
    {
        ...
        var wrappedMessage = Loc.GetString("chat-manager-entity-me-wrap-message",
            ("entityName", isFormatted ? string.Empty : name), // Sunrise-Edit
            ("entity", ent),
            ("message", isFormatted ? action : FormattedMessage.RemoveMarkupOrThrow(action))); // Sunrise-Edit
