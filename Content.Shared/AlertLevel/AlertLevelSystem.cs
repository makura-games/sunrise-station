...
public sealed partial class AlertLevelSystem : EntitySystem
{
        ...
        bool? locked = null)
    {
        ...
        var previousLevel = station.Comp.CurrentAlertLevel; // Sunrise-Edit - передаём предыдущий уровень Sunrise-системам
        ...
        // Sunrise added start - уведомляем Sunrise-системы с предыдущим уровнем тревоги
        RaiseSunriseAlertLevelChanged(station, level, previousLevel);
        // Sunrise added end
