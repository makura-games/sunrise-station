...
public sealed class StealthComponentState(float stealthLevel, TimeSpan? lastUpdated, bool enabled, float shimmerFrequency, bool mirage) : ComponentState
{
    ...
    public readonly bool Mirage = mirage;
}
