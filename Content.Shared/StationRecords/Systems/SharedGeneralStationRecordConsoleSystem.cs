...
public abstract partial class SharedGeneralStationRecordConsoleSystem : EntitySystem
{
    ...
    {
        if (!CanDeleteRecord(ent, args)) // Sunrise-Edit - серверная проверка доступа реализована в partial
            return;
    ...
    protected virtual bool CanDeleteRecord(Entity<GeneralStationRecordConsoleComponent> ent, DeleteStationRecord args)
    {
        return ent.Comp.CanDeleteEntries;
    }
