...
public sealed partial class ContentAudioSystem
{
    ...
    private void PlayRestartSound(RoundRestartCleanupEvent ev)
    {
        ...
        _lobbyRoundRestartAudioStream = _audio.PlayGlobal(
            ...
            Filter.Local(),
            false,
            // Sunrise-Edit - сохраняем пониженную громкость звука конца раунда
            _roundEndSoundEffectParams
                .AddVolume(_roundEndSoundEffectParams.Volume + SharedAudioSystem.GainToVolume(_configManager.GetCVar(CCVars.LobbyMusicVolume)))
                .AddVolume(-3f)
        )?.Entity;
    }
