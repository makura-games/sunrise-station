...
cmd-mapping-help = Синтаксис: mapping [MapID] [Path]
...
cmd-mapping-success-load-grid = Неинициализированный грид загружен из файла { $path } на новую карту с ID { $mapId }.
