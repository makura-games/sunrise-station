action-name-internals-toggle-on = Включить внутреннюю систему
action-description-internals-toggle-on = Дышите из экипированного газового баллона. Также требуется экипированная дыхательная маска.
action-name-internals-toggle-off = Выключить внутреннюю систему
action-description-internals-toggle-off = Дышите из окружающей среды.
internals-self-no-breath-tool = Вы не носите дыхательный инструмент
