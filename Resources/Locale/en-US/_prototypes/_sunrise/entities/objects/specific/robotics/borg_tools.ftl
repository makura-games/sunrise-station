...
ent-HandheldMassScannerBorg = cyborg mass scanner
    .desc = A handheld mass scanner powered by your own power cells.
ent-RadioJammerSyndicateBorg = cyborg radio jammer
    .desc = A Syndicate radio jammer.
    .suffix = Syndicate
