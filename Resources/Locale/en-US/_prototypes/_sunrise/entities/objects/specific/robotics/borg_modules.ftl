...
ent-BorgModuleRobotics = self-production module
    .desc = { ent-BaseBorgModule.desc }
ent-XenoborgModuleTurboLaser = xenoborg turbo laser module
    .desc = A module for a heavy xenoborg with a rapid-fire laser minigun.
ent-XenoborgModuleXray = xenoborg X-ray laser module
    .desc = A module for a heavy xenoborg with an X-ray cannon for penetrating cover.
ent-BorgModulePaperwork = cyborg office module
