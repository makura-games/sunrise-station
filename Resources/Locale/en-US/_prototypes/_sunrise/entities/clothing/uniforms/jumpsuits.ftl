...
ent-ClothingUniformJumpsuitSalvageMercBrown = brown scrapper jumpsuit
    .desc = Utilitarian clothing for salvagers.
ent-ClothingUniformJumpsuitCapTurtleneck = captain's turtleneck jumpsuit
    .desc = The true captain's turtleneck jumpsuit.
ent-ClothingUniformJumpsuitHoPTurtleneck = head of personnel's turtleneck jumpsuit
    .desc = This is the head of personnel's turtleneck jumpsuit.
ent-ClothingUniformJumpsuitHoSBlack = black head of security's jumpsuit
    .desc = This is the black head of security's jumpsuit.
ent-ClothingUniformJumpsuitRDClassical = research director's classic jumpsuit
    .desc = This is the research director's classic jumpsuit.
ent-ClothingUniformJumpsuitMilirUniform = form-fitting milir bodysuit
    .desc = A simple, form-fitting bodysuit adapted to milir anatomy.
