...
ent-ClothingOuterHardsuitPrivateSecDamaged = damaged private security hardsuit
    .desc = You didn't think ordinary soap would fix this junk, did you? It no longer protects its wearer from space.
ent-ClothingOuterHardsuitPrivateerDamaged = damaged privateer hardsuit
    .desc = A privateer hardsuit with cracked plates and punctured seals. It no longer protects its wearer from space.
    .suffix = Pirates
ent-ClothingOuterHardsuitPrivateerArmoredDamaged = damaged privateer armored hardsuit
    .desc = A privateer armored hardsuit with cracked plates and punctured seals. It no longer protects its wearer from space.
    .suffix = Pirates
ent-ClothingOuterHardsuitMilira = milira hardsuit
    .desc = A hardsuit designed specifically for Milira. It provides protection and lets you stay airborne longer.
ent-ClothingOuterHardsuitSalvageGoliath = goliath mining hardsuit
    .desc = A mining hardsuit trimmed with scraps of thick Goliath chitin.
ent-ClothingOuterHardsuitSpaceHazard = hazardous environment mining hardsuit
    .desc = A specialized hardsuit for working in hazardous environments and low-pressure conditions.
ent-ClothingOuterHardsuitAdvancedMining = advanced mining hardsuit
    .desc = An advanced mining hardsuit with an integrated jetpack.
ent-ClothingOuterHardsuitMining = mining hardsuit
    .desc = A hardsuit for mining in space under low-pressure conditions.
