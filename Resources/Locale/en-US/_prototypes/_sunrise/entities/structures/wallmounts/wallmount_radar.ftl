...
construction-graph-tag-radar-console-board = mass scanner computer board

ent-WallmountRadarAssembly = mass scanner computer assembly
    .desc = A mass scanner computer assembly.
