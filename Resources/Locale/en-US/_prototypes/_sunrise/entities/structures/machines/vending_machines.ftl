...
ent-VendingMachineSalvageTicket = salvager ticket vendor
    .desc = Exchanges salvager tickets for equipment.
ent-VendingMachineMiningTicket = miner ticket vendor
    .desc = Exchanges miner tickets for equipment.
