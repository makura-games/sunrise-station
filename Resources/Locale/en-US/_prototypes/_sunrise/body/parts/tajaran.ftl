...
ent-RightFootTajaran = right tajaran foot
    .desc = { ent-PartTajaran.desc }
ent-LeftLegTajaranCurved = tajaran left leg (curved)
    .desc = { ent-BaseLeftLeg.desc }
ent-RightLegTajaranCurved = tajaran right leg (curved)
    .desc = { ent-BaseRightLeg.desc }
ent-LeftFootTajaranCurved = tajaran left foot (curved)
    .desc = { ent-BaseLeftFoot.desc }
ent-RightFootTajaranCurved = tajaran right foot (curved)
